...
<ul>
 	<li>In the 'name:' field please enter a meaningful name like 'PMMlab install path' and in the text field ‘Location:’ please enter the following URL: https://dl.bintray.com/silebat/pmmlab/</li>
