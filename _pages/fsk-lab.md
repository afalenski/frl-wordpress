...
<div>FSK-Lab needs to be installed as a KNIME feature through the FSK-Lab update site Help > Install New Software > Add (<a href="https://www.knime.org/downloads/update">more info here</a>). The corresponding URL to be entered in the 'Add Repository' dialogue is: https://dl.bintray.com/silebat/fsklab</div>
<div></div>
&nbsp;
