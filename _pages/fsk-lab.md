...
<div>FSK-Lab needs to be installed as a KNIME feature through the FSK-Lab update site (<a href="https://www.knime.org/downloads/update">more info here</a>). The corresponding URL is:</br> https://dl.bintray.com/silebat/fsklab</div>
<div></div>
&nbsp;
